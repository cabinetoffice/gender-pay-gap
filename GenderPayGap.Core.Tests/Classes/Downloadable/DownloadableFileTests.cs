...
namespace GenderPayGap.Core.Tests.Classes.Downloadable
{
    ...
    public class DownloadableFileTests
    {
        ...
        [TestCase("filePath\\ManualChangeLog", "Manual Changes Log")]
        ...
        [TestCase("aPath\\ManualChangeLog", "Manual change history.")]
        ...
        [TestCase("location\\ManualChangeLog", "Manual Changes Log")]
