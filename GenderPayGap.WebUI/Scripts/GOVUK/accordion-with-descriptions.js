/* Copied from https://github.com/alphagov/service-manual-frontend/blob/master/app/assets/javascripts/modules/accordion-with-descriptions.js 
 * 2/8/2018 - Fix on Line 250 - Stephen McCabe
 */
...
(function (Modules) {
  ...
  Modules.AccordionWithDescriptions = function() {
    ...
    //Fix: this.title = that.$subsectionButton.text();
    this.title = $(location).attr('pathname') + '#' + $(that.$subsectionButton[0]).text();
