...
{
    public class ReportLateSubmissionViewModel : GovUkViewModel
    {
        ...
        public ReportLateSubmissionContactFromEhrc? ContactFromEhrc { get; set; }
    ...
    public enum ReportLateSubmissionContactFromEhrc
    {
        Yes,
        No
    }
