...
{
    public class NewLateSubmissionReasonViewModel : GovUkViewModel
    {
        ...
        public NewReportLateSubmissionReceivedLetterFromEhrc? ReceivedLetterFromEhrc { get; set; }
    ...
    public enum NewReportLateSubmissionReceivedLetterFromEhrc
    {
        Yes,
        No
    }
