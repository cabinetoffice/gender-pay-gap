...
namespace GenderPayGap.WebUI.Models.AccountCreation
{
    public class CreateUserAccountViewModel : GovUkViewModel
    {
        ...
        [GovUkDisplayNameForErrors(NameAtStartOfSentence = "First name", NameWithinSentence = "first name")]
        ...
        [GovUkDisplayNameForErrors(NameAtStartOfSentence = "Last name", NameWithinSentence = "last name")]
        [GovUkValidateCharacterCount(MaxCharacters = 50)]
        [GovUkValidateRequired(ErrorMessageIfMissing = "Please enter your last name.")]
        public string LastName { get; set; }

        [GovUkDisplayNameForErrors(NameAtStartOfSentence = "Job title", NameWithinSentence = "job title")]
        [GovUkValidateCharacterCount(MaxCharacters = 50)]
