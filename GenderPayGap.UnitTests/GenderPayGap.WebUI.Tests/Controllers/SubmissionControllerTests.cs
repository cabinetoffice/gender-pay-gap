...
namespace GenderPayGap.WebUI.Tests.Controllers
{
    ...
    public partial class SubmitControllerTests
    {
        ...
        public async Task SubmitController_CheckData_POST_Success()
        {
            ...
            var testDataRepository = MoqHelpers.CreateMockAsyncDataRepository().Object;
            var testDraftFileBL = new DraftFileBusinessLogic(testDataRepository);
            var testService = new SubmissionService(null, null, testDraftFileBL);
            ...
            IActionResult actionResult = await controller.CheckData(model);
            ...
            SubmitController_EnterCalculations_GET_When_User_Has_No_Return_Then_A_New_Private_Sector_Return_Should_Be_Created()
        {
            ...
            var testDataRepository = UiTestHelper.DIContainer.Resolve<IDataRepository>();
            var testDraftFileFileBusinessLogic = new DraftFileBusinessLogic(testDataRepository);
            ...
            actualDraftFile = testDraftFileFileBusinessLogic.GetExistingOrNew(
